...
| [azurerm_eventhub_namespace_authorization_rule.authorization_rule](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/eventhub_namespace_authorization_rule) | resource |
...
| <a name="input_namespace_authorization_rules"></a> [namespace\_authorization\_rules](#input\_namespace\_authorization\_rules) | Namsespace access policy list | <pre>list(object({<br>    name   = string<br>    listen = bool<br>    send   = bool<br>    manage = bool<br>  }))</pre> | `[]` | no |
