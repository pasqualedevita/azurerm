...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  eventhub_authorization_rule_id = var.eventhub_authorization_rule != null ? join("/", ["/subscriptions/", data.azurerm_subscription.subscription.subscription_id,
    "resourceGroups", var.eventhub_resource_group_name, "providers/Microsoft.EventHub/namespaces", var.eventhub_namespace_name,
    "authorizationrules",
